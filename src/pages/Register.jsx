    ...
    <section className='register'>
      <div className="container">
        ...
        <form className='form register_form' onSubmit={registerUser}>
          ...
          <input type="text" placeholder='Full Name' name='name' value={userData.name} onChange={handleInputChange} />
          ...
          <input type="password" placeholder='Confirm Password' name='password2' value={userData.password2} onChange={handleInputChange} />
